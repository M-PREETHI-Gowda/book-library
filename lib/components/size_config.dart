...
class SizeConfig {
  ...
  final textScale = _mediaQueryData.textScaleFactor.clamp(0.8, 1.5);
  final textScaleTwo = _mediaQueryData.textScaleFactor;

  void init(BuildContext context) {
    _mediaQueryData = MediaQuery.of(context).copyWith(textScaleFactor: textScale);
